class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "bf16[201088, 2880]", primals_2: "Sym(s0)", primals_3: "i64[1, s0]", primals_4: "Sym(s2)", primals_5: "bf16[1, s2, 2880]", primals_6: "i64[]"):
        ...
        slice_scatter: "i64[1, s0]" = torch.ops.aten.slice_scatter.default(permute, slice_1, 1, 0, -1);  permute = slice_1 = None
        ...
        select_scatter: "i64[1, s0]" = torch.ops.aten.select_scatter.default(slice_scatter, copy_1, 1, -1);  slice_scatter = copy_1 = None
        ...
        view_1: "bf16[s2, 2880]" = torch.ops.aten.view.default(primals_5, [-1, 2880]);  primals_5 = None
        ...
        view_2: "i64[s0]" = torch.ops.aten.view.default(select_scatter, [-1]);  select_scatter = None
